...
//on my way to become pupil
ll c=0;
vll arr;
void helper(ll i, vll arr2,ll a[],ll n){
 if(i==n){
  return;
 }
 for(ll k=0;k<arr2.size();k++){
  if(abs(arr[i]-arr2[k])<=1 and a[k]!=1){
