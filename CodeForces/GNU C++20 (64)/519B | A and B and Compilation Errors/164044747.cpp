...
void solve(){
    ...
    ll sum1=accumulate(arr1.begin(), arr1.end(),0LL);
    ll sum2=accumulate(arr2.begin(), arr2.end(),0LL);
    ll sum3=accumulate(arr3.begin(), arr3.end(),0LL);
    cout<<(sum1-sum2)<<endl;
    cout<<sum2-sum3<<endl;
}
